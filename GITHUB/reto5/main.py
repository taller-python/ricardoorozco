...
def main():
    ...
    while menu != 5:
        ...
        menu = int(input('Digite [1: Nuevo empleado, 2: Seleccionar empleado, 3: Modificar empleado, 4: Borrar empleado, 5: Salir, 6: Seleccionar todos]: '))
        ...
        if menu == 1:
            ...
            try:
                ...
                if result['status'] == 'ok':
                    print(json.dumps(result['empleados'], indent=4, default=json_util.default))
                else:
                    print(result['message'])
